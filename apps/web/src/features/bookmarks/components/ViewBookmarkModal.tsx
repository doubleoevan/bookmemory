    ...
    >
      ...
      >
        <div className="flex-1 overflow-y-auto overscroll-contain">
          ...
          {/* title section */}
          <h1 className="break-word wrap-anywhere">
          ...
          <p className="break-word wrap-anywhere">{bookmark?.description}</p>
          ...
          <p className="break-word wrap-anywhere">
            {summary || (isLoadingSummary ? "Generating..." : "")}
          </p>
          ...
          <div className="flex items-center justify-between text-muted-foreground">
            ...
            {tags.length > 0 ? (
              <>
                ...
                <span className="hidden md:inline!">Powered by semantic search ⚡</span>
              </>
            ) : (
